...
export default function AdminSecurity(props: Props) {
    ...
    return (
        <AppLayout>
            <AdminSettingsLayout>
                <Head title="Keamanan Akun Admin — Pusat Studi Kepolisian" />
            ...
            <div className="space-y-10">
                ...
                <div>
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-[#1f5476]">Ubah Kata Sandi Admin</h2>
                    ...
                    <Form
                        {...SecurityController.update['/admin/settings/password'].form()}
